...
<table 
	...
	<tr>
		...
		<th class="product-thumbnail"><?php esc_html_e( 'Product', 'riode' ); ?></th>
	...
	if ( $wishlist && $wishlist->has_items() ) :
			...
			if ( $product && $product->exists() ) :
				...
				<tr id="yith-wcwl-row-<?php echo esc_attr( $item->get_product_id() ); ?>" data-row-id="<?php echo esc_attr( $item->get_product_id() ); ?>">
					...
					<td class="product-name">
						...
						<a href="<?php echo esc_url( get_permalink( apply_filters( 'woocommerce_in_cart_product', $item->get_product_id() ) ) ); ?>">
							<?php echo riode_strip_script_tags( apply_filters( 'woocommerce_in_cartproduct_obj_title', $product->get_title(), $product ) ); ?>
						</a>
						...
						if ( $show_variation && $product->is_type( 'variation' ) ) {
							 ...
							 */
							echo riode_strip_script_tags( wc_get_formatted_variation( $product ) );
						}
						?>
					...
					<?php if ( $show_price || $show_price_variations ) : ?>
						<td class="product-price">
							...
							<?php
							if ( $show_price ) {
								echo riode_strip_script_tags( $item->get_formatted_product_price() );
							}

							if ( $show_price_variations ) {
								echo riode_strip_script_tags( $item->get_price_variation() );
							}
							?>
					...
					<?php if ( $show_quantity ) : ?>
						<td class="product-quantity">
							...
							<?php else : ?>
								<?php echo riode_strip_script_tags( $item->get_quantity() ); ?>
							<?php endif; ?>
					...
					<?php if ( $show_last_column ) : ?>
						<td class="product-add-to-cart">
							...
							<?php if ( $repeat_remove_button ) : ?>
								<a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item->get_product_id() ) ); ?>" class="remove_from_wishlist button" title="<?php echo apply_filters( 'yith_wcwl_remove_product_wishlist_message_title', esc_html__( 'Remove this product', 'yith-woocommerce-wishlist' ) ); ?>"><?php esc_html_e( 'Remove', 'yith-woocommerce-wishlist' ); ?></a>
							<?php endif; ?>
						</td>
					<?php endif; ?>
		...
		<tr>
			<td colspan="<?php echo esc_attr( $column_count ); ?>">
				<a class="woocommerce-Button button btn btn-dark btn-md" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>">
	...
	if ( ! empty( $page_links ) ) :
		...
		<tr class="pagination-row">
			<td colspan="<?php echo esc_attr( $column_count ); ?>"><?php echo riode_strip_script_tags( $page_links ); ?></td>
		</tr>
	<?php endif ?>
	</tbody>
