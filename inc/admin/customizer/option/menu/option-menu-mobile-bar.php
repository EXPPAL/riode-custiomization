...
Riode_Customizer::add_field(
	...
	array(
		...
		'choices'   => array(
			...
			'custom'   => esc_html__( 'Custom Link', 'riode' ),
		),
	)
);
...
Riode_Customizer::add_field(
	...
	array(
		'section'   => 'mobile_bar',
		'type'      => 'custom',
		'settings'  => 'cs_mobile_bar_customlink_title',
		'label'     => '',
		'default'   => '<h3 class="options-custom-title">' . esc_html__( 'Custom Link', 'riode' ) . '</h3>',
		'transport' => 'postMessage',
	)
);
...
Riode_Customizer::add_field(
	...
	array(
		'section'   => 'mobile_bar',
		'type'      => 'text',
		'settings'  => 'mobile_bar_custom_label',
		'label'     => esc_html__( 'Custom Link Label', 'riode' ),
		'transport' => 'refresh',
		'default'   => riode_get_option( 'mobile_bar_custom_label' ),
	)
);
...
Riode_Customizer::add_field(
	...
	array(
		'section'   => 'mobile_bar',
		'type'      => 'text',
		'settings'  => 'mobile_bar_custom_icon',
		'label'     => esc_html__( 'Custom Link Icon', 'riode' ),
		'transport' => 'refresh',
		'default'   => riode_get_option( 'mobile_bar_custom_icon' ),
	)
);
...
Riode_Customizer::add_field(
	...
	array(
		'section'   => 'mobile_bar',
		'type'      => 'text',
		'settings'  => 'mobile_bar_custom_url',
		'label'     => esc_html__( 'Custom Link URL', 'riode' ),
		'transport' => 'refresh',
		'default'   => riode_get_option( 'mobile_bar_custom_url' ),
	)
);
